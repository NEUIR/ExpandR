...
class EvaluateRetrieval:
    ...
    def __init__(self, retriever: Union[Type[DRES], Type[DRFS], Type[BM25], Type[SS]] = None, k_values: List[int] = [1,3,5,10,100,1000], score_function: str = "cos_sim", embeddings_file: str = "corpus_embeddings.npy"):
    ...
    def retrieve(self, corpus: Dict[str, Dict[str, str]], queries: Dict[str, str], **kwargs) -> Dict[str, Dict[str, float]]:
        ...
        return self.retriever.search(corpus, queries, self.top_k, self.score_function, self.embeddings_file, False, **kwargs)
